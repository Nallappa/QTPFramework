                        ...
                        <tr bgcolor="white">
						  ...
						  <td valign="middle" align="center" height="20">
                            <span class="text">
							  ...
							  <xsl:if test="not($DataSimulationAccurancy)">
									<xsl:value-of select="'N/A'"/>
							  </xsl:if>
							  <xsl:if test="$DataSimulationAccurancy">
						  ...
						  <td valign="middle" align="center" height="20">
                            <span class="text">
							  ...
							  <xsl:if test="not($PerformanceSimulationAccurancy)">
									<xsl:value-of select="'N/A'"/>
							  </xsl:if>
							  <xsl:if test="$PerformanceSimulationAccurancy">
